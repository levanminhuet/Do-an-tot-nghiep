  ...
  return (
    <div className="relative  p-4 h-full">
      <div className="flex items-center  justify-between border-b border-gray-800">
        <h3 className="font-bold text-[30px]  text-sky-400">Tổng quan</h3>
      </div>
      <div className="">
        <div className="flex gap-4  py-5 px-2 items-center">
          <div className="flex-1 border bg-blue-200  rounded-md shadow-md flex p-4 items-center justify-between">
            <span className="flex flex-col">
              <span className="font-bold text-[24px] text-blue-600">
                {data?.views || 0}
              </span>
              <span className="text-sm text-gray-500">SỐ LƯỢT TRUY CẬP</span>
            </span>
            <HiUserGroup size={30} color="" />
          </div>
          <div className="flex-1 border bg-blue-200 rounded-md shadow-md flex p-4 items-center justify-between">
            <span className="flex flex-col">
              <span className="font-bold text-[24px] text-blue-600">
        ...
        <div className="mt-5 ">
          <div className="flex gap-4 justify-between h-[400px]">
            ...
            <div className="flex-1 h-full shadow-lg rounded-md flex flex-col p-4">
              <h4 className="font-bold text-blue-400">Doanh thu</h4>
              <ChartLine
                data={data?.ctmb}
                isMonth={isMonth}
                customTime={customTime}
          ...
          <div className="flex gap-4 justify-between h-[400px]">
            ...
            <div className="flex-1 h-full shadow-lg rounded-md flex flex-col p-4">
              <h4 className="font-bold text-blue-400">
                Số thành viên đăng ký tài khoản mới
              </h4>
              <ChartLine
                data={data?.nct}
                isMonth={isMonth}
        ...
        <div className="mt-8 rounded-md shadow-lg p-4">
          <h4 className="font-bold text-blue-400">Các bài đăng mới nhất</h4>
