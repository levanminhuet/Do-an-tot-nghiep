      ...
      <div className="w-full lg:w-5/6 mx-2 mt-3">
        <div className="rounded w-full lg:flex mb-10 ">
          ...
          <div className="bg-white rounded px-4 flex flex-col justify-between leading-normal">
            <div>
              <div className="mt-3 md:mt-0 text-gray-700 font-bold text-2xl mb-2 uppercase">
                {props.name}
              </div>
              ...
              <p className="text-gray-600 text-base">{props.nearaddress}</p>
              <p className="text-gray-600 text-base">
                Phòng gồm: phòng ngủ, bếp ăn, nhà vệ sinh riêng
              </p>
              <p className="text-blue-600 text-xl">{props.price} VNĐ</p>
