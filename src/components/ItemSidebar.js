            ...
            content.map((item) => {
              return (
                <Link
                  ...
                  key={item.code}
                  className="flex gap-2 items-center cursor-pointer hover:text-blue-600 border-b border-gray-200 pb-1 border-dashed"
                >
                ...
                <div key={index} className="">
                  <div className=" flex items-center justify-around ">
                    <div
                      ...
                      className="flex flex-1 gap-2 items-center cursor-pointer hover:text-blue-600 border-b border-gray-200 pb-1 border-dashed"
                    >
                      <GrNext size={10} color="#ccc" />
                      <p>{item.left.value}</p>
                    </div>
