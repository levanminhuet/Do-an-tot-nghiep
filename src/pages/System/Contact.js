    ...
    <div className="w-full">
      ...
      <div className="flex gap-4">
        <div className="flex-1 flex flex-col gap-4 h-fit bg-red-400 rounded-3xl p-4 text-white bg-gradient-to-br from-blue-700 to-cyan-400">
          ...
          <span>Điện thoại: 0966 779 310</span>
          <span>Email: cskh.myhome@gmail.com</span>
          <span>Zalo: 0966 779 3101</span>
          <span>Viber: 0966 779 310</span>
          <span>Địa chỉ: LE-4.07, Toà nhà KangNam, Mỹ Đình, Hà Nội</span>
        </div>
